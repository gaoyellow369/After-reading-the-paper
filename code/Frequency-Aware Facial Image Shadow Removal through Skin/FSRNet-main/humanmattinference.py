...
def single_inference(model, img):
    ...
    weight_os4 = utils.util.get_unknown_tensor_from_pred(pred_alpha, rand_width=30, train_mode=False)
    pred_alpha[weight_os4>0] = alpha_pred_os4[weight_os4>0]
    weight_os1 = utils.util.get_unknown_tensor_from_pred(pred_alpha, rand_width=15, train_mode=False)
